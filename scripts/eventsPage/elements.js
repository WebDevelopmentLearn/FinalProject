...
export const selectTypeForm = document.querySelector("#selectTypeForm");
export const selectDistanceForm = document.querySelector("#selectDistanceForm");
export const selectCategoryForm = document.querySelector("#selectCategoryForm");
export const eventsList = document.querySelector(".eventsList");
export const selectTypeEvent = document.querySelector("#selectTypeEvent");
export const selectDistanceEvent = document.querySelector("#selectDistanceEvent");
export const selectCategoryEvent = document.querySelector("#selectCategoryEvent");
export const eventsFiltersContainer = document.querySelector(".eventsFiltersContainer");